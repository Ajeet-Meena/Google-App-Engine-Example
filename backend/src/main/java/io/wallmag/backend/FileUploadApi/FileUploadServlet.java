package io.wallmag.backend.FileUploadApi;
...
public class FileUploadServlet extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException {
        GcsFilename fileName = getFileName(httpServletRequest);
        if (SERVE_USING_BLOBSTORE_API) {
            ...
            copy(Channels.newInputStream(readChannel), httpServletResponse.getOutputStream());
        }
    }
     ...
     * @return
     */
    private GcsFilename getFileName(HttpServletRequest httpServletRequest) {
        String[] splits = httpServletRequest.getRequestURI().split("/", 4);
